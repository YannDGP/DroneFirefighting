...
class ObjectDetector:
    ...
    def __init__(self, model_size='small', conf_thres=0.5, iou_thres=0.45, classes=None, device=None, depth_estimator=None):
        ...
        model_name = '/home/jetson/Documents/Stage_Saxion/DroneFirefighting/best.pt' #model_map.get(model_size.lower(), model_map['small'])
        ...
        try:
            ...
            print(f"Loaded TensorRt Engine {model_size} model on {self.device}")
